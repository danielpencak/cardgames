    ...
    $xhr2.done((data2) => {
      ...
      const renderComputerCards = (() => {
        ...
        for (const computerCard of computerCards) {
          ...
          $img.attr({ alt: 'Card', src: 'assets/card_back.jpg' });
          $span.append($img);
        }
      });
      ...
      const checkForGameEnd = (() => {
        if (remainingCardsInDeck === 0) {
          ...
          if (userScore > computerScore) {
            <Toast toast="Congratulations! You won!"></Toast>
          }
          else if (userScore < computerScore) {
            <Toast toast="Sorry. You lost. Try again."></Toast>;
          }
          else {
            <Toast toast="Wow! It's a tie. Play again!"></Toast>;
          }
          $spanComputer.empty();
          $spanUser.empty();
        }
      ...
      const randomCardRequest = (() => {
        ...
        if (computerCards.length === 0) {
          ...
          <Toast toast={`Do you have a ${randomComputerCardRequest.value}?`}></Toast>;
